...
# podman build -t portfolio-fullstack-application/api3:latest $(for i in `cat .env`; do out+="--build-arg $i " ; done; echo $out;out="") .

podman run -t <IMAGE ID>
...
export KAFKA_ZOOKEEPER_PROTOCOL="${KSAFKA_ZOOKEEPER_PROTOCOL:-PLAINTEXT}"
