...
;// CONCATENATED MODULE: ../../node_modules/d3-shape/node_modules/d3-path/src/path.js
var pi = Math.PI,
    tau = 2 * pi,
    epsilon = 1e-6,
...
;// CONCATENATED MODULE: ../../node_modules/mermaid/dist/sankeyDiagram-0acdec17.js
...
const findOrCreateNode = (ID) => {
  ID = mermaid_0603ccf8.e.sanitizeText(ID, (0,mermaid_0603ccf8.c)());
  if (!nodesMap[ID]) {
...
const db = {
  nodesMap,
  getConfig: () => (0,mermaid_0603ccf8.c)().sankey,
  getNodes,
  getLinks,
  getGraph,
  addLink,
...
const draw = function(text, id, _version, diagObj) {
  const { securityLevel, sankey: conf } = (0,mermaid_0603ccf8.c)();
  const defaultSankeyConfig = mermaid_0603ccf8.H.sankey;
  let sandboxElement;
  ...
  const svg = securityLevel === "sandbox" ? root.select(`[id="${id}"]`) : (0,src/* select */.MlD)(`[id="${id}"]`);
  ...
  sankey$1(graph);
  const colorScheme = (0,src/* scaleOrdinal */.knW)(src/* schemeTableau10 */.ovr);
