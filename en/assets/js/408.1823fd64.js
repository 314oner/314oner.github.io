...
/* harmony export */ });
/* harmony import */ var _mermaid_0603ccf8_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(35676);
/* harmony import */ var _createText_423428c9_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(82712);
...
class TextDimensionCalculatorWithFont {
  ...
  getMaxDimension(texts, fontSize) {
    ...
    for (const t of texts) {
      const bbox = (0,_createText_423428c9_js__WEBPACK_IMPORTED_MODULE_4__.c)(elem, 1, t);
...
class BandAxis extends BaseAxis {
  constructor(axisConfig, axisThemeConfig, categories, title, textDimensionCalculator) {
    ...
    this.scale = (0,d3__WEBPACK_IMPORTED_MODULE_0__/* .scaleBand */ .iEe)().domain(this.categories).range(this.getRange());
  }
  setRange(range) {
    super.setRange(range);
  }
  recalculateScale() {
    this.scale = (0,d3__WEBPACK_IMPORTED_MODULE_0__/* .scaleBand */ .iEe)().domain(this.categories).range(this.getRange()).paddingInner(1).paddingOuter(0).align(0.5);
    _mermaid_0603ccf8_js__WEBPACK_IMPORTED_MODULE_5__.l.trace("BandAxis axis final categories, range: ", this.categories, this.getRange());
  }
  getTickValues() {
...
class LinearAxis extends BaseAxis {
  constructor(axisConfig, axisThemeConfig, domain, title, textDimensionCalculator) {
    super(axisConfig, title, textDimensionCalculator, axisThemeConfig);
    this.domain = domain;
    this.scale = (0,d3__WEBPACK_IMPORTED_MODULE_0__/* .scaleLinear */ .M89)().domain(this.domain).range(this.getRange());
  }
  getTickValues() {
  ...
  recalculateScale() {
    ...
    this.scale = (0,d3__WEBPACK_IMPORTED_MODULE_0__/* .scaleLinear */ .M89)().domain(domain).range(this.getRange());
  }
  getScaleValue(value) {
...
class LinePlot {
  ...
  getDrawableElement() {
    ...
    if (this.orientation === "horizontal") {
      path = (0,d3__WEBPACK_IMPORTED_MODULE_0__/* .line */ .cFK)().y((d) => d[0]).x((d) => d[1])(finalData);
    } else {
      path = (0,d3__WEBPACK_IMPORTED_MODULE_0__/* .line */ .cFK)().x((d) => d[0]).y((d) => d[1])(finalData);
    }
    if (!path) {
      return [];
    }
...
function getChartDefaultThemeConfig() {
  const defaultThemeVariables = (0,_mermaid_0603ccf8_js__WEBPACK_IMPORTED_MODULE_5__.D)();
  const config = (0,_mermaid_0603ccf8_js__WEBPACK_IMPORTED_MODULE_5__.E)();
  return (0,_mermaid_0603ccf8_js__WEBPACK_IMPORTED_MODULE_5__.B)(defaultThemeVariables.xyChart, config.themeVariables.xyChart);
}
function getChartDefaultConfig() {
  const config = (0,_mermaid_0603ccf8_js__WEBPACK_IMPORTED_MODULE_5__.E)();
  return (0,_mermaid_0603ccf8_js__WEBPACK_IMPORTED_MODULE_5__.B)(
    _mermaid_0603ccf8_js__WEBPACK_IMPORTED_MODULE_5__.A.xyChart,
    config.xyChart
  );
}
...
function textSanitizer(text) {
  const config = (0,_mermaid_0603ccf8_js__WEBPACK_IMPORTED_MODULE_5__.E)();
  return (0,_mermaid_0603ccf8_js__WEBPACK_IMPORTED_MODULE_5__.d)(text.trim(), config);
}
...
function getDrawableElem() {
  ...
  xyChartData.title = (0,_mermaid_0603ccf8_js__WEBPACK_IMPORTED_MODULE_5__.r)();
...
const draw = (txt, id, _version, diagObj) => {
  ...
  _mermaid_0603ccf8_js__WEBPACK_IMPORTED_MODULE_5__.l.debug("Rendering xychart chart\n" + txt);
  const svg = (0,_mermaid_0603ccf8_js__WEBPACK_IMPORTED_MODULE_5__.z)(id);
  ...
  (0,_mermaid_0603ccf8_js__WEBPACK_IMPORTED_MODULE_5__.i)(svg, chartConfig.height, chartConfig.width, true);
