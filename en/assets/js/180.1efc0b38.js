...
/* harmony import */ var dayjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(46388);
/* harmony import */ var dayjs_plugin_isoWeek_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(43008);
/* harmony import */ var dayjs_plugin_customParseFormat_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(91352);
/* harmony import */ var dayjs_plugin_advancedFormat_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(40460);
/* harmony import */ var _mermaid_0603ccf8_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(35676);
/* harmony import */ var d3__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(21988);
...
const clear = function() {
  ...
  lastOrder = 0;
  links = {};
  (0,_mermaid_0603ccf8_js__WEBPACK_IMPORTED_MODULE_7__.t)();
  weekday = "sunday";
};
...
const getStartDate = function(prevTime, dateFormat2, str) {
  ...
  if (mDate.isValid()) {
    ...
    _mermaid_0603ccf8_js__WEBPACK_IMPORTED_MODULE_7__.l.debug("Invalid date:" + str);
    _mermaid_0603ccf8_js__WEBPACK_IMPORTED_MODULE_7__.l.debug("With date format:" + dateFormat2.trim());
...
const setLink = function(ids, _linkStr) {
  ...
  if ((0,_mermaid_0603ccf8_js__WEBPACK_IMPORTED_MODULE_7__.c)().securityLevel !== "loose") {
    linkStr = (0,_braintree_sanitize_url__WEBPACK_IMPORTED_MODULE_0__/* .sanitizeUrl */ .oR)(_linkStr);
  }
...
const setClickFun = function(id, functionName, functionArgs) {
  ...
  if (rawTask !== void 0) {
    pushFun(id, () => {
      _mermaid_0603ccf8_js__WEBPACK_IMPORTED_MODULE_7__.u.runFunc(functionName, ...argList);
    });
  }
};
...
const ganttDb = {
  getConfig: () => (0,_mermaid_0603ccf8_js__WEBPACK_IMPORTED_MODULE_7__.c)().gantt,
  clear,
  setDateFormat,
  getDateFormat,
  ...
  setTodayMarker,
  getTodayMarker,
  setAccTitle: _mermaid_0603ccf8_js__WEBPACK_IMPORTED_MODULE_7__.s,
  getAccTitle: _mermaid_0603ccf8_js__WEBPACK_IMPORTED_MODULE_7__.g,
  setDiagramTitle: _mermaid_0603ccf8_js__WEBPACK_IMPORTED_MODULE_7__.q,
  getDiagramTitle: _mermaid_0603ccf8_js__WEBPACK_IMPORTED_MODULE_7__.r,
  setDisplayMode,
  getDisplayMode,
  setAccDescription: _mermaid_0603ccf8_js__WEBPACK_IMPORTED_MODULE_7__.b,
  getAccDescription: _mermaid_0603ccf8_js__WEBPACK_IMPORTED_MODULE_7__.a,
  addSection,
  getSections,
  getTasks,
  addTask,
...
const setConf = function() {
  _mermaid_0603ccf8_js__WEBPACK_IMPORTED_MODULE_7__.l.debug("Something is calling, setConf, remove the call");
};
const mapWeekdayToTimeFunction = {
  monday: d3__WEBPACK_IMPORTED_MODULE_5__/* .timeMonday */ .MHk,
  tuesday: d3__WEBPACK_IMPORTED_MODULE_5__/* .timeTuesday */ .mU8,
  wednesday: d3__WEBPACK_IMPORTED_MODULE_5__/* .timeWednesday */ .I5u,
  thursday: d3__WEBPACK_IMPORTED_MODULE_5__/* .timeThursday */ .eC,
  friday: d3__WEBPACK_IMPORTED_MODULE_5__/* .timeFriday */ .kjj,
  saturday: d3__WEBPACK_IMPORTED_MODULE_5__/* .timeSaturday */ .cLV,
  sunday: d3__WEBPACK_IMPORTED_MODULE_5__/* .timeSunday */ .LEI
};
...
const draw = function(text, id, version, diagObj) {
  const conf = (0,_mermaid_0603ccf8_js__WEBPACK_IMPORTED_MODULE_7__.c)().gantt;
  const securityLevel = (0,_mermaid_0603ccf8_js__WEBPACK_IMPORTED_MODULE_7__.c)().securityLevel;
  let sandboxElement;
  if (securityLevel === "sandbox") {
    sandboxElement = (0,d3__WEBPACK_IMPORTED_MODULE_5__/* .select */ .MlD)("#i" + id);
  }
  const root = securityLevel === "sandbox" ? (0,d3__WEBPACK_IMPORTED_MODULE_5__/* .select */ .MlD)(sandboxElement.nodes()[0].contentDocument.body) : (0,d3__WEBPACK_IMPORTED_MODULE_5__/* .select */ .MlD)("body");
  ...
  const timeScale = (0,d3__WEBPACK_IMPORTED_MODULE_5__/* .scaleTime */ .sle)().domain([
    (0,d3__WEBPACK_IMPORTED_MODULE_5__/* .min */ .SYq)(taskArray, function(d) {
      return d.startTime;
    }),
    (0,d3__WEBPACK_IMPORTED_MODULE_5__/* .max */ .kvL)(taskArray, function(d) {
      return d.endTime;
    })
  ...
  (0,_mermaid_0603ccf8_js__WEBPACK_IMPORTED_MODULE_7__.i)(svg, h, w, conf.useMaxWidth);
  ...
  function makeGant(tasks2, pageWidth, pageHeight) {
    ...
    const colorScale = (0,d3__WEBPACK_IMPORTED_MODULE_5__/* .scaleLinear */ .M89)().domain([0, categories.length]).range(["#00B9FA", "#F95002"]).interpolate(d3__WEBPACK_IMPORTED_MODULE_5__/* .interpolateHcl */ .mqd);
    drawExcludeDays(
      gap,
      topPadding,
      leftPadding,
  ...
  function drawRects(theArray, theGap, theTopPad, theSidePad, theBarHeight, theColorScale, w2) {
    ...
    if (securityLevel2 === "sandbox") {
      let sandboxElement2;
      sandboxElement2 = (0,d3__WEBPACK_IMPORTED_MODULE_5__/* .select */ .MlD)("#i" + id);
  ...
  function drawExcludeDays(theGap, theTopPad, theSidePad, w2, h2, tasks2, excludes2, includes2) {
    ...
    if (dayjs__WEBPACK_IMPORTED_MODULE_1__(maxTime).diff(dayjs__WEBPACK_IMPORTED_MODULE_1__(minTime), "year") > 5) {
      _mermaid_0603ccf8_js__WEBPACK_IMPORTED_MODULE_7__.l.warn(
  ...
  function makeGrid(theSidePad, theTopPad, w2, h2) {
    let bottomXAxis = (0,d3__WEBPACK_IMPORTED_MODULE_5__/* .axisBottom */ .s5Y)(timeScale).tickSize(-h2 + theTopPad + conf.gridLineStartPadding).tickFormat((0,d3__WEBPACK_IMPORTED_MODULE_5__/* .timeFormat */ .Yn0)(diagObj.db.getAxisFormat() || conf.axisFormat || "%Y-%m-%d"));
    ...
    if (resultTickInterval !== null) {
      ...
      switch (interval) {
        case "millisecond":
          bottomXAxis.ticks(d3__WEBPACK_IMPORTED_MODULE_5__/* .timeMillisecond */ .SgN.every(every));
          break;
        case "second":
          bottomXAxis.ticks(d3__WEBPACK_IMPORTED_MODULE_5__/* .timeSecond */ .qI6.every(every));
          break;
        case "minute":
          bottomXAxis.ticks(d3__WEBPACK_IMPORTED_MODULE_5__/* .timeMinute */ .i_y.every(every));
          break;
        case "hour":
          bottomXAxis.ticks(d3__WEBPACK_IMPORTED_MODULE_5__/* .timeHour */ .Weq.every(every));
          break;
        case "day":
          bottomXAxis.ticks(d3__WEBPACK_IMPORTED_MODULE_5__/* .timeDay */ .oLF.every(every));
          break;
        case "week":
          bottomXAxis.ticks(mapWeekdayToTimeFunction[weekday2].every(every));
          break;
        case "month":
          bottomXAxis.ticks(d3__WEBPACK_IMPORTED_MODULE_5__/* .timeMonth */ .IBc.every(every));
          break;
      }
    }
    svg.append("g").attr("class", "grid").attr("transform", "translate(" + theSidePad + ", " + (h2 - 50) + ")").call(bottomXAxis).selectAll("text").style("text-anchor", "middle").attr("fill", "#000").attr("stroke", "none").attr("font-size", 10).attr("dy", "1em");
    if (diagObj.db.topAxisEnabled() || conf.topAxis) {
      let topXAxis = (0,d3__WEBPACK_IMPORTED_MODULE_5__/* .axisTop */ .kP7)(timeScale).tickSize(-h2 + theTopPad + conf.gridLineStartPadding).tickFormat((0,d3__WEBPACK_IMPORTED_MODULE_5__/* .timeFormat */ .Yn0)(diagObj.db.getAxisFormat() || conf.axisFormat || "%Y-%m-%d"));
      if (resultTickInterval !== null) {
        const every = resultTickInterval[1];
        const interval = resultTickInterval[2];
        const weekday2 = diagObj.db.getWeekday() || conf.weekday;
        switch (interval) {
          case "millisecond":
            topXAxis.ticks(d3__WEBPACK_IMPORTED_MODULE_5__/* .timeMillisecond */ .SgN.every(every));
            break;
          case "second":
            topXAxis.ticks(d3__WEBPACK_IMPORTED_MODULE_5__/* .timeSecond */ .qI6.every(every));
            break;
          case "minute":
            topXAxis.ticks(d3__WEBPACK_IMPORTED_MODULE_5__/* .timeMinute */ .i_y.every(every));
            break;
          case "hour":
            topXAxis.ticks(d3__WEBPACK_IMPORTED_MODULE_5__/* .timeHour */ .Weq.every(every));
            break;
          case "day":
            topXAxis.ticks(d3__WEBPACK_IMPORTED_MODULE_5__/* .timeDay */ .oLF.every(every));
            break;
          case "week":
            topXAxis.ticks(mapWeekdayToTimeFunction[weekday2].every(every));
            break;
          case "month":
            topXAxis.ticks(d3__WEBPACK_IMPORTED_MODULE_5__/* .timeMonth */ .IBc.every(every));
            break;
        }
      }
  ...
  function vertLabels(theGap, theTopPad) {
    ...
    svg.append("g").selectAll("text").data(numOccurances).enter().append(function(d) {
      const rows = d[0].split(_mermaid_0603ccf8_js__WEBPACK_IMPORTED_MODULE_7__.e.lineBreakRegex);
